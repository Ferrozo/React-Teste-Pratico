            ...
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
                        Questione qualquer coisa!
                    </p>
                    <a href="mailto:" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">ferrozo.c@gmail.com</a>
                </div>
